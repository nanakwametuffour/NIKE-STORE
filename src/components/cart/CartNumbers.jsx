...
export default function CartNumbers({onCartToggle, totalQTY,  clearItems}) {
  return (
    <div className="bg-white h-11 flex justify-between items-center px-3  sticky w-full top-0 right-0 left-0 ">
      <div className="flex items-center gap-3">
        ...
        <div className="grid items-center">
          <h1 className="text-base font-medium text-slate-900">
            Your Cart
            <span className="bg-theme-cart rounded py-1 text-slate-100 font-normal text-sm ">
              ({totalQTY} Items)
            </span>
          </h1>
        </div>
      ...
      <div className="flex items-center">
        <button
          type="button" onClick={clearItems}
